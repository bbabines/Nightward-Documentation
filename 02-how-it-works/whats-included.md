...
Every domain below runs through the same verified pipeline — see **The Verified Edit Loop**.
...
compiled, and PIE-tested before it's called done — see **The Verified Edit Loop** and **Honest
Limits**.
